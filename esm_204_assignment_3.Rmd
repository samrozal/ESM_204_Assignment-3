...
```{r}
price_low = seq(0, 30, length.out = 100)
...
```{r}
price_high = seq(0, 30, length.out = 100)
...
ggplot() +
  ...
  geom_line(df_2, mapping=aes(demand_low,price_low))+
  geom_line(df_3, mapping=aes(demand_high,price_high))
```
