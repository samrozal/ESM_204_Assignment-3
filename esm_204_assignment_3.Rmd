...
```
```{r}
demand_p_t_eq <- function(q)  (model_demand_l$coefficients[[1]]+model_demand_h$coefficients[[1]])- 1.96 + ((model_demand_l$coefficients[[2]]+model_demand_h$coefficients[[2]])*q) 
