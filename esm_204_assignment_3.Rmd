...
ggplot(df_2, aes(demand_low, price_low)) +
  geom_line() + 
  labs(title = "Low Income Demand", x = "low income demand", y = "low income price") + 
  theme_light()
```
...
ggplot(df_2, aes(demand_high, price_high)) +
  geom_line() + 
  labs(title = "High Income Demand", x = "high demand", y = "high price") + 
  theme_light()
```
...
ggplot(df, aes(Qagg, price)) +
  geom_line() + 
  labs(title = "Aggregate Demand", x = "Aggregate Demand Curve", y = "Price") + 
  theme_light()
...
ggplot(df_4, aes(q_supply,supply_price)) +
  geom_line() + 
  labs(title = "Supply Curve", x = "Q Supply", y = "Price of Supply") + 
  theme_light()
...
**A:** The amount of electricity produced and consumed is $`r round(q_tax_51, 2)` kWh. 
**B:** The price of electricity is $`r round(p_tax_51, 2)`/kWh
...
#however, low income consumers will bear the brunt of the environmental cost, so we need to calculate the total environmental cost.
...
```{r}
# calculate environmental damage --> Did this already, reference:
...
l_welfare_150 <- (consumer_surplus_low_t_150 + low_consume * tax_revenue_t_150)
```
