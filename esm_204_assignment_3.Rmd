...
>>>>>>> 6a533e7e1e4037a2dd86316f76ed75f6351c3ae5
```
...
consumer_surplus_low <- CS(price_low,model_demand_l)
consumer_surplus_high <- CS(price_high,model_demand_h)

consumer_surplus_agg <- CS_agg(price)
