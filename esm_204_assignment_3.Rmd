...
**A:** The overall welfare to “high” income consumers is $`r round(h_welfare_75, 2)`.

**B:** The overall welfare of “low” income consumers is $`r round(l_welfare_75, 2)`.
...
**A:** The overall welfare to “high” income consumers is $`r round(h_welfare_100, 2)`.

**B:** The overall welfare of “low” income consumers is $`r round(l_welfare_100, 2)`.
...
**A:** The overall welfare to “high” income consumers is $`r round(h_welfare_125, 2)`.

**B:** The overall welfare of “low” income consumers is $`r round(l_welfare_125, 2)`.
...
**A:** The overall welfare to “high” income consumers is $`r round(h_welfare_150, 2)`.

**B:** The overall welfare of “low” income consumers is $`r round(l_welfare_150, 2)`.
...
- The total environmental damage is the area under the MEC evaluated at Q. For the situation where" "high” income group has access to solar panels, the environmental cost is $5671.87. 

- Tax * Q = 567186.6

- Q =  289380.9

- Tax * 289380.9 = 567186.6

- Tax = `r 567186.6/289380.9`cents

- Tax = $`r(567186.6/289380.9)/100`
