...
**B:** The price of electricity under a tax is $`r round(p_tax_51/100, 3)`. It decreased from status quo
...
**C:** The overall welfare of "high" income consumers under a new tax is $`r round(consumer_surplus_high_t_51, 0)`.

**D:** The overall welfare of "low" income consumers under a new tax is $`r round(consumer_surplus_low_t_51, 0)`. 
...
**E:** Power suppliers will have a producer surplus of $`r round(ps_change/100, 0)` under a tax.
...
**F:** The total environmental damage be $`r round(environmental_cost_t_51, 0)` under a tax.
